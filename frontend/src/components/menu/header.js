...
const AddressText = styled.text`color: white;`;
...
const Header = function() {
	...
	useEffect(() => {
		...
		async function getCurrentWallet() {
			let userWalletData = await getCurrentWalletConnected();
			console.log(userWalletData);
			addressRef.current = userWalletData.address;
			setAddressState(userWalletData.address);
		}
											...
											{openMenu && (
												<div className="item-dropdown">
													<div className="dropdown" onClick={closeMenu}>
														...
														<NavLink to="/home2" onClick={() => btn_icon(!showmenu)}>
															Homepage 1
														</NavLink>
													</div>
												</div>
											...
											{openMenu2 && (
												<div className="item-dropdown">
													<div className="dropdown" onClick={closeMenu2}>
														...
														<NavLink to="/loginTwo" onClick={() => btn_icon(!showmenu)}>
															login 2
														</NavLink>
